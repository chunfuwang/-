...
function isFixedProvider(itemOrId){
    ...
    return id === 'modelscope' || id === 'runninghub' || id === 'volcengine' || id === 'deepseek' || id === 'mimo';
}
...
function sortedProviders(){
    const order = ['modelscope', 'runninghub', 'volcengine', 'deepseek', 'mimo'];
...
function renderProviderList(){
    providerList.innerHTML = sortedProviders().map(item => {
        ...
        const protocolLabel = item.id === 'runninghub' ? 'RH' : item.id === 'mimo' ? 'MiMo' : String(item.protocol || 'openai').toUpperCase();
        if(item.id === 'modelscope'){
            return `
        ...
        if(item.id === 'deepseek'){
            return `
                <button class="provider-card provider-card-banner ${active} ${stateClass}" type="button" onclick="selectProvider('${escapeHtml(item.id)}')">
                    <span class="provider-banner-inner">
                        <span class="provider-logo-wrap">
                            <img src="/static/images/deepseek-icon-light.svg" alt="DeepSeek" class="ms-icon-light">
                            <img src="/static/images/deepseek-icon-dark.svg" alt="DeepSeek" class="ms-icon-dark">
                            <span class="provider-logo-fallback">DeepSeek</span>
                        </span>
                        <span class="provider-protocol-pill">OpenAI</span>
                    </span>
                </button>
        ...
        if(item.id === 'mimo'){
            return `
                <button class="provider-card provider-card-banner ${active} ${stateClass}" type="button" onclick="selectProvider('${escapeHtml(item.id)}')">
                    <span class="provider-banner-inner">
                        <span class="provider-logo-wrap">
                            <img src="/static/images/mimo-icon-light.svg" alt="MiMo" class="ms-icon-light">
                            <img src="/static/images/mimo-icon-dark.svg" alt="MiMo" class="ms-icon-dark">
                            <span class="provider-logo-fallback">MiMo</span>
                        </span>
                        <span class="provider-protocol-pill">MiMo</span>
                    </span>
                </button>
            `;
        }
